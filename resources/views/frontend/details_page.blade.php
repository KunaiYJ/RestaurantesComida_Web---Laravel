                ...
                <ul class="nav" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-order-online-tab" data-toggle="pill"
                            ...
                            aria-selected="true">Ordene en línea</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-gallery-tab" data-toggle="pill" href="#pills-gallery"
                            role="tab" aria-controls="pills-gallery" aria-selected="false">Galería</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-restaurant-info-tab" data-toggle="pill"
                            ...
                            aria-selected="false">Información del restaurante</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-book-tab" data-toggle="pill" href="#pills-book" role="tab"
                            aria-controls="pills-book" aria-selected="false">Reservar mesa</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-reviews-tab" data-toggle="pill" href="#pills-reviews"
                            role="tab" aria-controls="pills-reviews" aria-selected="false">Calificaciones y reseñas</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-order-online" role="tabpanel"
                            ...
                            <div id="#menu" class="bg-white rounded shadow-sm p-4 mb-4 explore-outlets">
                                <h6 class="mb-3">Más populares <span class="badge badge-success"><i
                                        ...
                                        <div class="item">
                                            <div class="mall-category-item">
                                                <a href="#">
                                                    ...
                                                    <h6>{{ $populer->name }}</h6>
                                                    @if ($populer->descount_price == NULL)
                                                        ${{$populer->price}}
                                                    @else
                                                        $<del>{{$populer->price}}</del> ${{$populer->descount_price}}
                                                    @endif
                            ...
                            <div class="row">
                                <h5 class="mb-4 mt-3 col-md-12">Los más vendidos</h5>
                            ...
                            @foreach ($menus as $menu)
                                ...
                                <div class="row">
                                    <h5 class="mb-4 mt-3 col-md-12">{{ $menu->menu_name }} 
                                        <small class="h6 text-black-50">
                                            {{ $menu->products->count() }} ITEMS
                                        </small>
                                    </h5>
                                    <div class="col-md-12">
                                        ...
                                        @foreach ($gallerys as $index => $gallery)
                                            ...
                                            <div class="item">
                                                ...
                                                <div class="position-absolute restaurant-slider-pics bg-dark text-white">
                                                    {{ $index + 1 }} of {{$gallerys->count()}} Fotos
                                                </div>
                                            </div>
                                                ...
                                                <span class="total-like-user-main ml-2" dir="rtl">
                                                    <a data-toggle="tooltip" data-placement="top"
                                                        title="Gurdeep Osahan" href="#"><img
                                                            alt="Generic placeholder image" src="img/user/5.png"
                                                            class="total-like-user rounded-pill"></a>
                                                    <a data-toggle="tooltip" data-placement="top"
                                                        title="Gurdeep Singh" href="#"><img
                                                            alt="Generic placeholder image" src="img/user/2.png"
                                                            class="total-like-user rounded-pill"></a>
                                                    <a data-toggle="tooltip" data-placement="top"
                                                        title="Askbootstrap" href="#"><img
                                                            alt="Generic placeholder image" src="img/user/3.png"
                                                            class="total-like-user rounded-pill"></a>
            ...
            <div class="col-md-4">
                <div class="pb-2">
                    <div
                        ...
                        <h6 class="pt-0 text-primary mb-1 font-weight-bold">¡ OFERTA !</h6>

                        {{-- <pre>{{ print_r(Session::get('coupon'), true) }}</pre> --}}

                        @if ($coupon == NULL)
                            <p class="mb-0"> No hay cupón disponible </p>
                        @else
                            <p class="mb-0"> 
                                {{ $coupon->discount }}% De descuento en -
                                <span class="text-success font-weight-bold"> {{ $coupon->coupon_name }} </span>
                            </p>
                        @endif
                ...
                <div class="generator-bg rounded shadow-sm mb-4 p-4 osahan-cart-item">
                    <h5 class="mb-1 text-white">Tus Ordenes</h5>
                    <p class="mb-4 text-white">{{ count((array) session('cart')) }} Productos Seleccionados</p>
                        ...
                        @if (session('cart'))
                            @foreach (session('cart') as $id => $details)
                                ...
                                <div class="gold-members p-2 border-bottom">
                                    ...
                                    <div class="media">
                                        <div class="mr-2">
                                            <img src="{{ asset($details['image']) }}" width="40px">
                                        </div>
                                        <div class="media-body">
                    ...
                    @if (Session::has('coupon'))
                        <div class="mb-2 bg-white rounded p-2 clearfix">
                            ...
                            <p class="mb-1 text-success">Descuento Total 
                            ...
                            <hr />
                            <h6 class="font-weight-bold mb-0">Pagar
                                <span class="float-right">
                                    @if (Session::has('coupon'))
                    ...
                    @else
                        <div class="mb-2 bg-white rounded p-2 clearfix">
                            ...
                            <input type="text" class="form-control" placeholder="Código promocional" id="coupon_name">
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="submit" id="button-addon2" onclick="ApplyCoupon()">
                                    <i class="icofont-sale-discount"></i> APLICAR </button>
                            </div>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="mb-2 bg-white rounded p-2 clearfix">
                        ...
                        <p class="seven-color mb-1 text-right">Pueden aplicarse cargos adicionales</p>
                    </div>
                    <a href="{{ route('checkout') }}" class="btn btn-success btn-block btn-lg">
                        Verificar <i class="icofont-long-arrow-right"></i>
                    </a>
                </div>
            </div>
        </div>
