    ...
    <section class="section pt-5 pb-5 products-section">
        <div class="container">
            ...
            <div class="row">
                ...
                @php
                    $clients = App\Models\Client::latest()->where('state', 1)->get();
                @endphp
                            ...
                            <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                ...
                                <div class="p-3 position-relative">
                                    ...
                                    <div class="list-card-badge">
                                        @if ($coupons)
                                            <span class="badge badge-success">OFFER</span> <small>{{ $coupons->discount }}% off | Usar el cupón de {{ $coupons->coupon_name }}</small>
                                        @else
                                            <span class="badge badge-success">OFFER</span>
                                            <small>En este momento no hay cupón</small>
                                        @endif
                                    </div>
                                </div>
                            </div>
