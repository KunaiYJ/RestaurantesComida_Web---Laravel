                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <img alt="Generic placeholder image" src="{{ !empty($profileData->photo) ? url('upload/user_images/' . $profileData->photo) : url('upload/no_image_user.webp') }}" class="nav-osahan-pic rounded-pill">
                            Mi Cuenta
                        </a>
                ...
                <li class="nav-item dropdown dropdown-cart">
                    ...
                    <div class="dropdown-menu dropdown-cart-top p-0 dropdown-menu-right shadow-sm border-0">
                            ...
                            @if (session('cart'))
                                @foreach (session('cart') as $id => $details)
                                    ...
                                    <p class="mb-2">
                                        ...
                                        <span class="float-right text-secondary">${{ $details['price'] }}</span></p>
                                @endforeach
                            @endif
                        ...
                        <div class="dropdown-cart-top-footer border-top p-2">
                            <a class="btn btn-success btn-block btn-lg" href="{{ route('checkout') }}"> Verificar</a>
                        </div>
                    </div>
                </li>
            </ul>
