...
<head>
    ...
    <title>Inicia Sesion - Comida en Linea</title>
    <!-- Favicon Icon -->
                        ...
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto pl-5 pr-5">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <button type="submit"
                                        class="btn btn-lg btn-outline-primary btn-block btn-login text-uppercase font-weight-bold mb-2">Iniciar Sesión</button>
                                    <div class="text-center pt-3">¿No tienes una Cuenta? 
                                        <a class="font-weight-bold" href="{{ route('register') }}">Registrate</a>
                                    </div>
                                </form>

                                <hr class="my-4">
                                <p class="text-center">Inicia Sesion Con</p>
                                <div class="row">
                                    <div class="col pr-2">
                                        <button
