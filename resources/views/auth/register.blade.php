...
<head>
    ...
    <title>Registrate - Comida en Linea</title>
    <!-- Favicon Icon -->
                        ...
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto pl-5 pr-5">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <button type="submit"
                                        class="btn btn-lg btn-outline-primary btn-block btn-login text-uppercase font-weight-bold mb-2">Registrarse</button>
