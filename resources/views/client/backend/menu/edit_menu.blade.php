        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Modificar Menú</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                            <li class="breadcrumb-item active">Modificar Menú</li>
                        </ol>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div>
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="menu_name" type="text" id="example-text-input" placeholder="Eje. Menu de Hamburguesas Gurmet" value="{{ $menu->menu_name }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mt-3 mt-lg-0">
                                    ...
                                    <div class="mb-3">
                                        <img id="showImage" src="{{ asset($menu->image) }}" alt="" class="rounded-circle p-1 bg-primary" width="150">
                                    </div>
