            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Agregar Cupón</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Agregar Cupón</li>
                            </ol>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="coupon_name" id="coupon_name" class="form-control"
                                            placeholder="Ej. Descuento para una Hamburguesa">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="coupon_desc" id="coupon_desc" class="form-control"
                                            placeholder="Ej. Este cupon es valido para....">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-group mb-3">
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" name="validity" min="{{ Carbon\Carbon::now()->format('Y-m-d') }}" id="validity" class="form-control">
                                    </div>
                                </div>
