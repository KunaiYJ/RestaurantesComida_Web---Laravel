                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-dark mb-0">
                                <tbody>
                                    <tr>
                                        <th width="50%">Nombre del Envío :</th>
                                        <td>{{ $order->name }}</td>
                                    </tr>
                                    <tr>
                                        <th width="50%">Teléfono del Envío :</th>
                                        <td>{{ $order->phone }}</td>
                                    </tr>
                                    <tr>
                                        <th width="50%">Correo del Envío :</th>
                                        <td>{{ $order->email }}</td>
                                    </tr>
                                    <tr>
                                        <th width="50%">Dirección del Envío :</th>
                                        <td>{{ $order->address }}</td>
                                    </tr>
                                    <tr>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="ms-3">Factura: <span class="text-danger">{{ $order->invoice_no }}</span></p>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @switch($order->status)
                                                @case('Pendiente')
                                                    <a href="{{ route('pending_to_confirm', $order->id) }}" class="btn btn-success w-100">Confirmar Orden</a>
                                                    @break
                                                @case('Confirmada')
                                                    <a href="{{ route('confirm_to_processing', $order->id) }}" class="btn btn-info w-100">Procesar Orden</a>
                                                    @break
                                                @case('Proceso')
                                                    <a href="{{ route('processing_to_deliverd', $order->id) }}" class="btn btn-primary w-100">Entregar Orden</a>
                                                    @break
                                            @endswitch
                                        </td>
                                    </tr>
