        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Modificar Categoria</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div>
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="category_name" value="{{ $category->category_name }}" type="text" id="example-text-input" placeholder="Eje. Hamburguesas">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mt-3 mt-lg-0">
                                    ...
                                    <div class="mb-3">
                                        <img id="showImage" src="{{ asset($category->image) }}" alt="" class="rounded-circle p-1 bg-primary" width="150">
                                    </div>
